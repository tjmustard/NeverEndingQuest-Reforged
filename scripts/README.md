...
3. **Configure your AI provider**: Copy `config_template.py` to `config.py` and add your API key (OpenAI, Gemini, or Ollama)
4. **Launch the game**: `python run_web.py` - opens the web interface at <http://localhost:8358>
5. **Start your adventure**: The AI will guide you through character creation and module selection
...
Edit `config.py` to configure your preferred AI provider (OpenAI, Gemini, or Ollama).

#### Available Model Options

**OpenAI:**

- `gpt-4o` (Full, most capable)
...
LLM_PROVIDER = "gemini"  # "openai", "gemini", or "ollama"

# Primary models
DM_MAIN_MODEL = "gemini-2.5-pro"  # Main storytelling
DM_SUMMARIZATION_MODEL = "gemini-2.5-flash"  # Compression
DM_VALIDATION_MODEL = "gemini-2.5-flash"  # Rule validation

# Specialized models
DM_COMBAT_NARRATOR_MODEL = "gemini-2.5-flash"  # Combat
MODULE_CREATION_MODEL = "gemini-2.5-flash"  # Content generation
```
